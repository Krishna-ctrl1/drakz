...
// Create Blog Comments Model - specify the collection name explicitly
const BlogComment = mongoose.model('BlogComment', blogCommentSchema, 'blog_comments');

console.log('Blog Comments schema and model created successfully');
