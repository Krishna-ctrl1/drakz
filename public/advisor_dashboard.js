...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const openModalBtn = document.getElementById('add-client-open-btn');
    ...
    if (clientForm) {
        clientForm.addEventListener('submit', async (event) => {
            ...
            console.log('Submitting new client:', newClientData);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (clientPhotoInput) {
        clientPhotoInput.addEventListener('change', function() {
...
async function populateCountryDropdown() {
    ...
    try {
        ...
        errorOption.value = '';
        errorOption.textContent = 'Could not load countries';
