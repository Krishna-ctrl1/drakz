...
const serviceDetails = {
  "bill-pay": {
    ...
    description:
      "Our online bill payment service allows you to pay your bills quickly and securely from anywhere, at any time. Save time and never miss a payment again.",
    features: [
  ...
  "merchant-services": {
    ...
    description:
      "Our merchant services provide businesses with comprehensive payment processing solutions. Accept payments in-store, online, or on-the-go with our secure and reliable platform.",
    features: [
  ...
  "treasury-services": {
    ...
    description:
      "Our treasury management solutions help businesses optimize cash flow, improve operational efficiency, and enhance financial control.",
    features: [
...
const userAccountDetails = {
  loan: {
    ...
    loans: [
      ...
      {
        type: "Auto Loan",
        accountNumber: "AL-857294",
        balance: "₹125,000",
        nextPayment: "28/10/2025",
        interestRate: "9.2%",
        term: "5 years",
      },
    ],
  ...
  creditScore: {
    ...
    factors: [
      ...
      },
      {
        ...
        impact: "High",
        status: "Good",
        description: "You are using 25% of your available credit.",
      },
      {
        name: "Length of Credit History",
        impact: "Medium",
        status: "Excellent",
        description: "Your oldest account is 12 years old.",
      },
      {
        name: "Credit Mix",
        impact: "Low",
  ...
  financialAdvisory: {
    ...
    recentActivity: [
      {
        date: "25/09/2025",
        note: "Discussed portfolio rebalancing and risk tolerance.",
      },
      {
        date: "10/08/2025",
        note: "Reviewed Q2 performance and market trends.",
      },
    ],
  },
};
...
function printReceipt() {
  ...
  if (receiptContent) {
    ...
    printWindow.document.write(
      "<style> body { font-family: Arial, sans-serif; } table { width: 100%; border-collapse: collapse; } th, td { padding: 8px; border: 1px solid #ddd; text-align: left; } .positive-amount { color: green; } .negative-amount { color: red; } </style>",
    );
